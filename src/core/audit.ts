...
export type AuditAction =
  ...
  | 'EHR_CHANGE_REQUESTED' | 'EHR_CHANGE_APPROVED' | 'EHR_CHANGE_REJECTED'
  | 'EMERGENCY_ACCESS' | 'TELEMEDICINE_JOINED' | 'TELEMEDICINE_ENDED'
  | 'APPOINTMENT_CHECKIN' | 'QUEUE_CALLED' | 'ENCOUNTER_STARTED'
